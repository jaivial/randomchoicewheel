...
import { ContentSections } from './components/ContentSections.js';
...
class DecisionWheelApp {
  ...
  initializeComponents() {
    try {
      ...
      // Initialize Content Sections (for AdSense compliance content)
      this.components.contentSections = new ContentSections(this.components.languageManager);
  ...
  /**
   * Setup dynamic translatable content sections
   */
  setupDynamicContent() {
    try {
      if (this.components.contentSections) {
        // Replace static HTML content with dynamic components
        this.components.contentSections.replaceStaticContent();
        console.log('Dynamic content sections initialized');
      }
    } catch (error) {
  ...
  cleanup() {
    ...
    // Cleanup content sections
    if (this.components.contentSections) {
      this.components.contentSections.destroy();
    }
